...
namespace PPR.DAL.Initializers
{
    public class PPRInitializer : DropCreateDatabaseIfModelChanges<PPRContext>
    {
        protected override void Seed(PPRContext context)
        {
            ...
            context.SaveChanges();
            LastRepair lr1 = new LastRepair { RepairType = "о", Technician = "Петров", Date = new DateTime(2018, 02, 01), Equipment = e1 };
            LastRepair lr2 = new LastRepair { RepairType = "м", Technician = "Липницкий", Date = new DateTime(2018, 02, 03), Equipment = e2 };
            LastRepair lr3 = new LastRepair { RepairType = "с", Technician = "Рудинский", Date = new DateTime(2018, 02, 10), Equipment = e3 };
            LastRepair lr4 = new LastRepair { RepairType = "к", Technician = "Смирнова", Date = new DateTime(2018, 02, 08), Equipment = e4 };
            LastRepair lr5 = new LastRepair { RepairType = "о", Technician = "Жуков", Date = new DateTime(2018, 02, 06), Equipment = e5 };
            LastRepair lr6 = new LastRepair { RepairType = "м", Technician = "Сидоров", Date = new DateTime(2018, 02, 14), Equipment = e6 };
            LastRepair lr7 = new LastRepair { RepairType = "с", Technician = "Власова", Date = new DateTime(2018, 02, 13), Equipment = e7 };
            LastRepair lr8 = new LastRepair { RepairType = "к", Technician = "Васильев", Date = new DateTime(2018, 02, 16), Equipment = e8 };
            LastRepair lr9 = new LastRepair { RepairType = "о", Technician = "Степанов", Date = new DateTime(2018, 02, 20), Equipment = e9 };
            LastRepair lr10 = new LastRepair { RepairType = "к", Technician = "Смирнова", Date = new DateTime(2018, 01, 02), Equipment = e10 };
            context.LastRepairs.AddRange(new List<LastRepair> { lr1, lr2, lr3, lr4, lr5, lr6, lr7, lr8, lr9, lr10 });
            context.SaveChanges(); 
            NextRepair nr1 = new NextRepair { RepairType = "с", Technician = "Степанов", Date = new DateTime(2018, 03, 01), Equipment = e1 };
            NextRepair nr2 = new NextRepair { RepairType = "о", Technician = "Васильев", Date = new DateTime(2018, 03, 03), Equipment = e2 };
            NextRepair nr3 = new NextRepair { RepairType = "к", Technician = "Власова", Date = new DateTime(2018, 03, 10), Equipment = e3 };
            NextRepair nr4 = new NextRepair { RepairType = "к", Technician = "Сидоров", Date = new DateTime(2018, 03, 08), Equipment = e4 };
            NextRepair nr5 = new NextRepair { RepairType = "м", Technician = "Смирнова", Date = new DateTime(2018, 03, 06), Equipment = e5 };
            NextRepair nr6 = new NextRepair { RepairType = "о", Technician = "Жуков", Date = new DateTime(2018, 03, 14), Equipment = e6 };
            NextRepair nr7 = new NextRepair { RepairType = "о", Technician = "Рудинский", Date = new DateTime(2018, 03, 13), Equipment = e7 };
            NextRepair nr8 = new NextRepair { RepairType = "с", Technician = "Липницкий", Date = new DateTime(2018, 03, 16), Equipment = e8 };
            NextRepair nr9 = new NextRepair { RepairType = "м", Technician = "Петров", Date = new DateTime(2018, 03, 20), Equipment = e9 };
            NextRepair nr10 = new NextRepair { RepairType = "о", Technician = "Степанов", Date = new DateTime(2018, 02, 04), Equipment = e10 };
